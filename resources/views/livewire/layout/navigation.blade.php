            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <x-application-logo class="block h-8 w-auto fill-current text-gray-800 dark:text-gray-200 fill-gray-500 dark:fill-gray-400 hover:fill-gray-700 dark:hover:fill-gray-300" />
                    </a>
                </div>
